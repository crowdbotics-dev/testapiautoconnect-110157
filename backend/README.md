...
## Project Structure
    ...
    ├── testapiautoconnect_110157  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_110157`
...
2. Clone this repo and `cd testapiautoconnect_110157`
